            ...
            <main className="flex-grow pt-24 pb-16 sm:py-32">
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="max-w-3xl mx-auto text-center mb-16">
                        <FadeIn>
                            <span className="text-sm font-bold uppercase tracking-widest text-primary mb-4 block">Get In Touch</span>
                            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tighter text-foreground mb-6">
                                Contact Us
                            </h1>
                            <p className="text-lg text-muted-foreground">
                                Have a question, want to volunteer, or just want to share your thoughts? We'd love to hear from you. Fill out the form below or reach out directly.
                            </p>
                        </FadeIn>
                    </div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-muted-foreground">Campaign Headquarters<br />Zangon Kataf, Kaduna State<br />Nigeria</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-muted-foreground">info@honamosmagaji.com</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
