            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <a href="#volunteer" className="inline-flex h-12 items-center justify-center rounded-sm border-2 border-primary px-6 sm:px-8 text-sm font-medium text-primary hover:bg-primary hover:text-white transition-colors">
                            Join the Campaign
                        </a>
                    </div>
                </motion.div>
