                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-7 lg:pl-12">
                        <FadeIn>
                            ...
                            <h2 className="text-4xl lg:text-5xl font-bold tracking-tighter mb-8 text-foreground whitespace-pre-line">
                                {data?.about_headline || "A Life of Service,\nGuided by Purpose."}
                            </h2>

                            {/* This is where the magic happens! We inject the HTML and style it using Tailwind's arbitrary variants */}
                            <div 
                                className="
                                    ...
                                    /* Paragraph styles */
                                    [&>p]:leading-relaxed
                                    /* Blockquote styles matching the static design */
                                ...
                                dangerouslySetInnerHTML={{ 
                                    __html: data?.about_content || `
                                        <p>Born in 1971, Hon. Amos Gwamna Magaji has always been driven by a singular vision: to improve the lives of the people around him. From his early dreams of medicine, leading to his studies in Human Physiology, to his successful career consulting in occupational health and safety across Abuja and Lagos, his path has been defined by care.</p>
                                        <p>His transition into public service was not born of ambition, but of necessity. Recognizing that true change required systemic influence, he stepped forward to represent Zangon Kataf/Jaba.</p>
                                        <blockquote>"Leadership is a calling to serve, uplift, and unite. Our strength lies in our community, our tolerance, and our shared faith in a better tomorrow."</blockquote>
                                        <p>Now serving his second term and chairing the House Committee on Health, his journey from the private sector to national leadership stands as a testament to lifelong dedication to public well-being.</p>
                                    `
                                }}
                            />
                        </FadeIn>
